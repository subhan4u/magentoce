<?php
	...
	namespace Javid\Learning\Plugin\Block;
	...
	class LayoutProcessor
	{
	    ...
	    )
	    {
            ...
            $jsLayoutResult['components']['checkout']['children']['steps']['children']['shipping-step']
            ['children']['shippingAddress']['children']['billingAddress']['children']['address-fieldset']['children']['bdelivery'] = $this->customField('billingAddress','bdelivery');
            ...
            $jsLayoutResult['components']['checkout']['children']['steps']['children']['shipping-step']['children']['shippingAddress']['children']['shipping-address-fieldset']['children']['sdelivery'] = $this->customField('shippingAddress','sdelivery');
        ...
        /**
        * Custom field for delivery address
        * @param $attributecode
        * @param $scope
        * @return array
        */
        public function customField($scope, $attributecode){
            $customField = [
                ...
                'dataScope' => $scope.'.custom_attributes' . '.' . $attributecode,
