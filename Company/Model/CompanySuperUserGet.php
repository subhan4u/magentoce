...
class CompanySuperUserGet
{
    ...
    /**
     * @var \Javid\Company\Model\CustomerRetriever
     */
     ...
     * @param \Javid\Company\Model\CustomerRetriever $customerRetriever
     */
    public function __construct(
        ...
        \Javid\Company\Model\CustomerRetriever $customerRetriever
    ) {
    ...
    public function getUserForCompanyAdmin(array $data): \Magento\Customer\Api\Data\CustomerInterface
    {
        ...
        $customerStatus = $customer->getId() ?
            $companyAttributes->getStatus() : \Javid\Company\Api\Data\CompanyCustomerInterface::STATUS_ACTIVE;
