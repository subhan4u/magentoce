 ...
 */
class Order extends AbstractExtensibleModel implements \Javid\Company\Api\Data\CompanyOrderInterface
{
    /**
    ...
    {
        $this->_init(\Javid\Company\Model\ResourceModel\Order::class);
    }
