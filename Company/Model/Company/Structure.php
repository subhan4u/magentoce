...
{
    /**
     * @var \Javid\Company\Model\ResourceModel\Structure\Tree
     */
    private $tree;

    /**
     * @var \Javid\Company\Api\Data\StructureInterfaceFactory
     */
    ...
    /**
     * @param \Javid\Company\Model\ResourceModel\Structure\Tree $tree
     * @param \Javid\Company\Api\Data\StructureInterfaceFactory $structureFactory
    ...
    public function __construct(
        \Javid\Company\Model\ResourceModel\Structure\Tree $tree,
        \Javid\Company\Api\Data\StructureInterfaceFactory $structureFactory,
     ...
     * @return \Javid\Company\Api\Data\StructureInterface|null
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    private function getTargetStructure(\Javid\Company\Api\Data\StructureInterface $structure)
    {
        if ($structure) {
            $entityType = $structure->getEntityType();
            if ($entityType == \Javid\Company\Api\Data\StructureInterface::TYPE_TEAM) {
                return $structure;
            } elseif ($entityType == \Javid\Company\Api\Data\StructureInterface::TYPE_CUSTOMER &&
