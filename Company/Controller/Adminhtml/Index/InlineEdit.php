...
class InlineEdit extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Javid_Company::manage';
     ...
     * @see \Javid\Company\Model\Company\Save for possible errors.
     *
     * @return bool
     */
    ...
    {
        return $this->_authorization->isAllowed('Javid_Company::manage');
    }
}
