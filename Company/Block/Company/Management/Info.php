 ...
 */
namespace Javid\Company\Block\Company\Management;

use Magento\Framework\View\Element\Template\Context;
use Magento\Authorization\Model\UserContextInterface;
use Javid\Company\Api\CompanyManagementInterface;
...
class Info extends \Magento\Framework\View\Element\Template
{
    ...
    {
        return $this->authorization->isAllowed('Javid_Company::users_edit');
    }
    ...
    {
        return $this->authorization->isAllowed('Javid_Company::roles_edit');
    }
